...
class Matrix(object):
    ...
    def inverse(self):
        ...
        if self.w == 1:
            ...
            inv[0][0] = self.g[1][1] * (1/self.determinant())
            inv[0][1] = -self.g[0][1] * (1/self.determinant())
            inv[1][0] = -self.g[1][0] * (1/self.determinant())
            inv[1][1] = self.g[0][0] * (1/self.determinant())
        ...
        for x in range(self.h):
            for y in range(other.w):
                for z in range(other.h):
                    result[x][y] += self.g[x][z] * other.g[z][y]
        return result
